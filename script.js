...
// كلمة السر الأساسية المطلوبة باللغة العربية
...
// 👑 فحص كلمة السر العربي الإلزامي عند الضغط على الزرار 👑
function checkPassword() {
    const passInput = document.getElementById('password-input');
    const errorMessage = document.getElementById('error-message');
    const loginScreen = document.getElementById('login-screen');
    
    // الفحص الدقيق بدون مسافات زايدة
    if (passInput && passInput.value.trim() === CORRECT_PASSWORD) {
        if (loginScreen) {
        ...
        // لو كتبت غلط الصندوق بيتهز ويطلع رسالة خطأ
